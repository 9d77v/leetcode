...
var tests = []struct {
	...
	{"should be equal", args{4, [][]int{{0, 1}, {0, 2}, {1, 2}}}, 1},
	{"should be equal", args{6, [][]int{{0, 1}, {0, 2}, {0, 3}, {1, 2}, {1, 3}}}, 2},
	{"should be equal", args{6, [][]int{{0, 1}, {0, 2}, {0, 3}, {1, 2}}}, -1},
	{"should be equal", args{5, [][]int{{0, 1}, {0, 2}, {3, 4}, {2, 3}}}, 0},
}
